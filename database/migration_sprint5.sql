...
-- Agregar columna rol a personas (sincronizacion con JPA)
ALTER TABLE personas ADD COLUMN IF NOT EXISTS rol VARCHAR(10) DEFAULT 'USER';

-- Indices para mejorar rendimiento en FKs
